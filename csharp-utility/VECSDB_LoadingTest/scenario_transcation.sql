...
Insert into EXPENSECTL.ASK_PRMASTER
 ...
 Values
   ('1CEN-H50001', '2', TO_DATE('05/16/2017 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), '000081', 'DB4407', 
    '曾飛', 'DB4407', 'RMB', '1', '74112', 
    '2', '5', '0', 'F3223842', '0', 
    TO_DATE('05/16/2017 09:02:48', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 09:12:18', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'N', '3', 'LH', 'N', 'Y', 
    'N', 'N', '1', 'N', 'N', 
    'N', 'N', 'N', 'Y', '1');
COMMIT;
...
Insert into EXPENSECTL.ASK_PRDETAIL
 ...
 Values
   ('1CEN-H50001', 1, '2CEN-H50001', 1, '1616005-0010058', 
...
Insert into EXPENSECTL.ASK_PRDETAIL
   (BILLNO, ITEM, POBILLNO, POITEM, PARTNUMBER, 
    ...
    JUDGEFLAG, FINALQTY, ISINVALID, LASTDATE)
 Values
   ('1CEN-H50001', 2, '2CEN-H50001', 2, '0207004-0140020', 
...
Insert into EXPENSECTL.BUY_POMASTER
   (BILLNO, BILLTYPE, PURDATE, COMPANYID, PURDEPT, 
    ...
    VTAXRATE)
 Values
   ('2CEN-H50001', '2', TO_DATE('05/16/2017 09:37:40', 'MM/DD/YYYY HH24:MI:SS'), '000081', 'DB4407', 
    'VCN0015486', 'M0909', 'G009', 17, 'LH05', 
    'RMB', 1, 'N', '2', '74112', 
    '5', 'F3223842', TO_DATE('05/16/2017 09:37:40', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 09:48:15', 'MM/DD/YYYY HH24:MI:SS'), 
    'F3223842', TO_DATE('05/16/2017 10:50:11', 'MM/DD/YYYY HH24:MI:SS'), 'N', '3', 'LH', 
    'N', 'N', 'N', ' ', 'N', 
    'N', '1', 'G', 'N', 'RMB2', 
    0);  
...
Insert into EXPENSECTL.BUY_PODETAIL
 ...
 Values
   ('2CEN-H50001', 1, '0207004-0140020', '調速接頭', '氣立可/CHELIC', 
    'QSC10-02', '個', 23.3, 23.3, 0, 
    1, 1, TO_DATE('05/30/2017 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), '中國', 0, 
    0, 'N', 27.261);
...
Insert into EXPENSECTL.BUY_PODETAIL
   (BILLNO, ITEM, PARTNUMBER, PNAME, BRAND, 
    ...
    SUBTAXRATE, RETURNFLAG, TAXPRICE)
 Values
   ('2CEN-H50001', 2, '1616005-0010058', '間隙片/矽鋼片/泊片', 'H+S', 
    'L5000*W50*T0.02mm', '盒', 255, 255, 0, 
    1, 1, TO_DATE('05/30/2017 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), '德國', 0, 
    0, 'N', 262.65);
...
Insert into EXPENSECTL.CHK_ACPMASTER
 ...
 Values
   ('3INE-H50001', '2CEN-H50001', 'LH05', '3', 'F3223842', 
    TO_DATE('05/16/2017 10:08:06', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 10:40:35', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 10:40:35', 'MM/DD/YYYY HH24:MI:SS'), 
    'N', 'N', 'N', 'N');
COMMIT;
...
Insert into EXPENSECTL.CHK_ACPDETAIL
   (BILLNO, ITEM, POITEM, PARTNUMBER, PNAME, 
    ...
    REFUSEQTY, SUMRGQTY)
 Values
   ('3INE-H50001', 1, 1, '0207004-0140020', '調速接頭', 
...
Insert into EXPENSECTL.CHK_ACPDETAIL
   (BILLNO, ITEM, POITEM, PARTNUMBER, PNAME, 
    ...
    REFUSEQTY, SUMRGQTY)
 Values
   ('3INE-H50001', 2, 2, '1616005-0010058', '間隙片/矽鋼片/泊片', 
...
Insert into EXPENSECTL.CHK_ASKREC
 ...
 Values
   ('3INE-H50001', 1, '1CEN-H50001', 1, 1);
Insert into EXPENSECTL.CHK_ASKREC
   (CHKBILLNO, CHKBILLITEM, ASKBILLNO, ASKITEM, QTY)
 Values
   ('3INE-H50001', 2, '1CEN-H50001', 2, 1);
COMMIT;
...
Insert into EXPENSECTL.TKM_TAKEMASTER
   (BILLNO, BILLTYPE, PRBILLNO, VENCODE, POBILLNO, 
    ...
    TOFN)
 Values
   ('4CEN-H50001', '2', '1CEN-H50001', 'VCN0015486', '2CEN-H50001', 
    'LH05', 'DB4407', '1', '3', 'F3223842', 
    TO_DATE('05/16/2017 10:43:14', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 10:49:35', 'MM/DD/YYYY HH24:MI:SS'), 'F3223842', TO_DATE('05/16/2017 10:49:38', 'MM/DD/YYYY HH24:MI:SS'), 
    'N', 'N', 'N', 'N', 'N', 
    'N', TO_DATE('01/01/2010 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'N', 'N', TO_DATE('05/16/2017 11:00:33', 'MM/DD/YYYY HH24:MI:SS'), 
    'N');
COMMIT;
...
Insert into EXPENSECTL.tkm_takeDetail
   (BILLNO, ITEM, PARTNUMBER, PNAME, BRAND, 
    SPEC, UNITCODE, QTY, PRITEM, BACKTAX, 
    JUDGEFLAG)
 Values
   ('4CEN-H50001', 1, '0207004-0140020', '調速接頭', '氣立可/CHELIC', 
    'QSC10-02', '個', 1, 1, 'N', 
    'N');
Insert into EXPENSECTL.tkm_takeDetail
   (BILLNO, ITEM, PARTNUMBER, PNAME, BRAND, 
    ...
    JUDGEFLAG)
 Values
   ('4CEN-H50001', 2, '1616005-0010058', '間隙片/矽鋼片/泊片', 'H+S', 
    'L5000*W50*T0.02mm', '盒', 1, 2, 'N', 
    'N');
COMMIT;
