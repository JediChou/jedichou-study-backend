...
func filenamesFromCommandLine() (inFilename, outFilename string, err error) {
	...
	if inFilename != "" && inFilename == outFilename {
		log.Fatal("won'toverwritetheinfile")
	}
...
func americanise(inFile io.Reader, outFile io.Writer) (err error) {
	...
	for !eof {
		...
		if err == io.EOF {
			err = nil  //io.EOFisn'treallyanerror
			eof = true //thiswillendtheloopatthenextiteration
		} else if err != nil {
			return err //finishimmediatelyforrealerrors
		}
